...
### 29.	Apache-CommonsCollections 是众多Java 反序列化漏洞中重要的Gadget，请简单描述 CommonsCollections(3.1) 为什么能用来执行任意命令<br>
参考解答：<br>
...
### 36.	甲给你一个目标站，并且告诉你根目录下存在/abc/目录，并且此目录下存在编辑器和admin目录。请问你的想法是？<br>
...
<br>
(5)日志清理，history历史清理，文件~/.bash_history <br>
<br>
(6)总结报告及修复方案<br>
